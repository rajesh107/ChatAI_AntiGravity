...
1. id: bigint - Numeric LinkedIn organization ID. Primary key. Join to statistics tables via: CAST(REPLACE(organization_entity, 'urn:li:organization:', '') AS UNSIGNED) = organization.id
